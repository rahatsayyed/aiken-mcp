...
const AiCodeReviews: React.FC = () => {
  const themeVars = {
    ...
    "--ai-background-color": "var(--background)",
    "--ai-text-color": "var(--foreground)",
    "--ai-text-dark": "var(--primary-foreground)",
    "--ai-border-color": "var(--border)",
    "--ai-border-main": "color-mix(in srgb, var(--foreground) 10%, transparent)",
    "--ai-highlight-primary": "color-mix(in srgb, var(--primary) 12%, transparent)",
    "--ai-highlight-header": "color-mix(in srgb, var(--accent) 20%, transparent)",
  }
