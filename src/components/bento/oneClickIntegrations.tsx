...
const OneClickIntegrationsIllustration: React.FC<OneClickIntegrationsIllustrationProps> = ({ className = "" }) => {
  const themeVars: Record<string, string> = {
    "--oci-primary-color": "var(--primary)",
    "--oci-background-color": "var(--background)",
    "--oci-foreground-color": "var(--foreground)",
    "--oci-muted-foreground-color": "var(--muted-foreground)",
    "--oci-border-color": "var(--border)",
    "--oci-shadow-color": "rgba(0, 0, 0, 0.12)",
    "--oci-gradient-light-gray-start": "color-mix(in srgb, var(--foreground) 20%, transparent)",
