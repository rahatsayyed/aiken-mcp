...
const ParallelCodingAgents: React.FC<ParallelCodingAgentsProps> = ({ className = "" }) => {
  ...
  const themeVars = {
    "--pca-background-color": "var(--background)",
    "--pca-background-glass": "color-mix(in srgb, var(--card) 20%, transparent)",
    "--pca-background-gradient-start": "color-mix(in srgb, var(--card) 20%, transparent)",
    "--pca-background-gradient-end": "transparent",
    "--pca-text-primary": "var(--foreground)",
    "--pca-text-secondary": "var(--muted-foreground)",
    "--pca-border-color": "var(--border)",
    "--pca-border-main": "var(--border)",
    "--pca-shadow-color": "rgba(0, 0, 0, 0.12)", // Keeping as is, common shadow
    "--pca-container-background": "color-mix(in srgb, var(--card) 40%, transparent)",
    "--pca-container-gradient-start": "color-mix(in srgb, var(--card) 40%, transparent)",
    ...
    >
      ...
      <div
        style={{
          ...
          background: "linear-gradient(180deg, color-mix(in srgb, var(--primary) 5%, transparent) 0%, transparent 100%)", // Updated background property
          backdropFilter: "blur(16px)",
          borderRadius: "9.628px",
          border: "0.802px solid var(--border)",
          overflow: "hidden",
          boxSizing: "border-box",
