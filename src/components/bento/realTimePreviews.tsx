...
const RealtimeCodingPreviews: React.FC = () => {
  const themeVars = {
    "--realtime-primary-color": "var(--primary)",
    "--realtime-background-editor": "color-mix(in srgb, var(--background) 80%, transparent)", // Tinted gray from background
    "--realtime-background-preview": "color-mix(in srgb, var(--background) 80%, transparent)", // Tinted gray from background
    "--realtime-text-color": "var(--foreground)",
    "--realtime-text-editor": "var(--foreground)",
    "--realtime-text-preview": "var(--primary-foreground)", // For button text
    "--realtime-border-color": "var(--border)",
    "--realtime-border-main": "var(--border)",
    "--realtime-connection-color": "var(--muted-foreground)",
  }
