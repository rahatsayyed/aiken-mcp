      ...
      <div className="absolute inset-0 top-[-90px]">
        ...
        >
          ...
          <defs>
            ...
            >
              <stop offset="0.1294" stopColor="var(--primary-dark)" />
      ...
      <div className="relative z-10 flex flex-col justify-start items-center gap-9 max-w-4xl mx-auto">
        <div className="flex flex-col justify-start items-center gap-4 text-center">
          ...
          <p className="text-muted-foreground text-sm md:text-base font-medium leading-[18.20px] md:leading-relaxed break-words max-w-2xl">
            Connect your AI assistant to Aiken&apos;s complete documentation and standard library through our MCP server
          </p>
        </div>
        <Link href={siteConfig.links.github} target="_blank" rel="noopener noreferrer">
          <Button
            className="px-[30px] py-2 bg-secondary-foreground text-secondary text-base font-medium leading-6 rounded-[99px] shadow-[0px_0px_0px_4px_rgba(255,255,255,0.13)] hover:bg-secondary-foreground/90 transition-all duration-200"
            size="lg"
          >
            Get Started
          </Button>
