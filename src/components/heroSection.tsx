    ...
    >
        ...
        >
          <g clipPath="url(#clip0_186_1134)">
            ...
            <g mask="url(#mask0_186_1134)">
              ...
              <rect x="699.711" y="81" width="36" height="36" fill="var(--foreground)" fillOpacity="0.08" />
              <rect x="195.711" y="153" width="36" height="36" fill="var(--foreground)" fillOpacity="0.09" />
              <rect x="1023.71" y="153" width="36" height="36" fill="var(--foreground)" fillOpacity="0.09" />
              <rect x="123.711" y="225" width="36" height="36" fill="var(--foreground)" fillOpacity="0.09" />
              <rect x="1095.71" y="225" width="36" height="36" fill="var(--foreground)" fillOpacity="0.09" />
              <rect x="951.711" y="297" width="36" height="36" fill="var(--foreground)" fillOpacity="0.09" />
              <rect x="231.711" y="333" width="36" height="36" fill="var(--foreground)" fillOpacity="0.07" />
              <rect x="303.711" y="405" width="36" height="36" fill="var(--foreground)" fillOpacity="0.07" />
              <rect x="87.7109" y="405" width="36" height="36" fill="var(--foreground)" fillOpacity="0.09" />
              <rect x="519.711" y="405" width="36" height="36" fill="var(--foreground)" fillOpacity="0.08" />
              <rect x="771.711" y="405" width="36" height="36" fill="var(--foreground)" fillOpacity="0.09" />
              <rect x="591.711" y="477" width="36" height="36" fill="var(--foreground)" fillOpacity="0.07" />
            </g>
          ...
          <defs>
            ...
            >
              ...
              <stop offset="0.578125" stopColor="var(--primary-light)" />
            ...
            >
              <stop stopColor="var(--foreground)" />
              <stop offset="0.157789" stopColor="var(--primary-light)" />
              <stop offset="1" stopColor="var(--primary)" />
            </radialGradient>
      ...
      <div className="relative z-10 space-y-4 md:space-y-5 lg:space-y-6 mb-6 md:mb-7 lg:mb-9 max-w-md md:max-w-[500px] lg:max-w-[588px] mt-16 md:mt-[120px] lg:mt-[160px] px-4">
        ...
        <p className="text-muted-foreground text-base md:text-base lg:text-lg font-medium leading-relaxed max-w-lg mx-auto">
          Connect AI assistants to Aiken&apos;s standard library, language tour, and module implementations through MCP.
        </p>
      </div>

      <Link href={"#configuration"}>
        <Button className="relative z-10 bg-secondary-foreground text-secondary hover:bg-secondary-foreground/90 px-8 py-3 rounded-full font-medium text-base shadow-lg ring-1 ring-white/10">
          Get Started
        </Button>
      </Link>
    </section>
