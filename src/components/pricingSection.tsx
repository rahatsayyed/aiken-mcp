...
export function PricingSection() {
  ...
  const pricingPlans = [
    {
      ...
      monthlyPrice: "$0",
      annualPrice: "$0",
      description: "Perfect for individuals learning Aiken.",
      features: [
        "Full language tour access",
        "Complete standard library docs",
        "Module source code access",
        "Community support",
    ...
    },
    {
      ...
      monthlyPrice: "$20",
      annualPrice: "$16",
      description: "Ideal for professional Aiken developers.",
      features: [
        "Hosted MCP server instance",
    ...
    },
    {
      ...
      buttonClass:
        "bg-zinc-300 shadow-[0px_1px_1px_-0.5px_rgba(16,24,40,0.20)] text-secondary-foreground text-shadow-[0px_1px_1px_rgba(16,24,40,0.08)] hover:bg-secondary/90",
    },
  ]
  ...
  return (
    <section className="w-full px-5 overflow-hidden flex flex-col justify-start items-center my-0 py-8 md:py-14">
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          <h2 className="text-center text-foreground text-4xl md:text-5xl font-semibold leading-tight md:leading-[40px]">
            Pricing for Aiken developers
          </h2>
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-tight">
            Choose a plan that fits your Aiken development needs, from individuals starting out to <br /> growing teams
      ...
      <div className="self-stretch px-5 flex flex-col md:flex-row justify-center items-start gap-4 md:gap-6 mt-6 max-w-[1400px] mx-auto">
        {pricingPlans.map((plan) => (
          <div
            key={plan.name}
            className={`flex-1 min-w-0 md:flex-[1_1_400px] p-6 overflow-hidden rounded-xl flex flex-col justify-start items-start gap-6 ${plan.popular ? "bg-primary shadow-[0px_4px_8px_-2px_rgba(0,0,0,0.10)]" : "bg-gradient-to-b from-gray-50/5 to-gray-50/0"}`}
            style={plan.popular ? {} : { outline: "1px solid var(--border)", outlineOffset: "-1px" }}
          >
